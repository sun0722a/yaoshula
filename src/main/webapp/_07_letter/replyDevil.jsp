	 ...
	 <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-xl-10 col-lg-12 col-md-9 mt-5">
            ...
            <div class="card o-hidden border-0 shadow-lg my-5 " id="contentBox">
              <div class="card-body p-0" >
                <div class="row">
                
                  <!-- 左側圖片 -->
                  <div class="col-lg-6 d-none d-lg-block pl-5 pt-5 pb-5 pr-4" ><img src="<c:url value='/image/_07_letter/replyDevil2.png' /> " ></div>
                    ...
                    <div class="pl-5 pt-4 pb-5 pr-5 ml-2" id="borderdiv">
                      <div class="text-center">
                        <h4 class=" text-gray-900 mb-2">惡魔信件<img src="<c:url value='/image/_07_letter/devil.png' />" class="animated  fadeInUp"></h4>
                        	...
                        	<div class="text-center">${lb.letterTitle}</div> 
                        	<br>
...
<!--                           <textarea cols="30" rows="10" id="letterContent" maxlength="250" name="content"></textarea> -->
                        	<div class="text-center">${lb.letterContent}</div> 
                        </div>
                        <button type="submit" name="devil" class="btn btn-primary btn-user btn-block" role="button" id="replyDevilbtn" >回覆</button>
...
<!--             回信的部分 -->
            <div class="card o-hidden border-0 shadow-lg my-5 "  id="replyBox">
              <div class="card-body p-0" >
                <div class="row">
