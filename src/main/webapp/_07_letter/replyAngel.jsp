...
<meta charset="UTF-8">
 <link
    ...
    <link rel="stylesheet" href="<c:url value='/css/_07_letter/replyAngel.css' /> ">
              ...
              <div class="card-body p-0" >
                <div class="row">
                  ...
                  <div class="col-lg-6 d-none d-lg-block pl-3 pt-5 pb-5" >
                	<img src="<c:url value='/image/_07_letter/replyAngel3.png' /> " id="leftImg" >
<!--                  <span id="writeMode" >123</span> -->
                 </div>
                 <c:forEach var="letter" items="${lb}">
                  <div class="col-lg-6">
                    <div class="pl-5 pt-4 pb-5 pr-5 ml-2" id="borderdiv">
                      ...
                      <div class="text-center">
                        ...
                        <div class="text-center">${letter.letterTitle}</div>    
                        	<br>
