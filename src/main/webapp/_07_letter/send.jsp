...
<meta charset="UTF-8">
    ...
    <link rel="stylesheet" href="<c:url value='/css/_07_letter/send.css' /> ">
...
<body>
	<div class="container">
        <div class="box">
            <div class="imgBox">
                <img class="happyImg" src="<c:url value='/image/_07_letter/sendAngel.png' /> ">
            </div>
        ...
        <div class="box">
            <div class="imgBox">
                <img class="sadImg" src="<c:url value='/image/_07_letter/replyDark.png' /> ">
            </div>
