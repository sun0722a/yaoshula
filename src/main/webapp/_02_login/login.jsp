...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/_02_login/template_style.css">
  <!-- my css -->
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/_02_login/style.css" />
                ...
                <div class="p-5">
                 ...
                 <form class="box" action="" method="post"
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="memberId"  placeholder="輸入您的帳號"
                      	value="${requestScope.memberId}${param.memberId}"> 
                      	<p class="error">${ErrorMsgKey.AccountEmptyError}</p>
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user"  name="password" id="exampleInputPassword" placeholder="輸入您的密碼"
                    ...
                    <input type="submit" class="btn btn-primary btn-user btn-block" value="立即登入" onclick="LoginForm.action='<c:url value="/login"  />'; ">
