	...
	<div class="w-75 my-5 mx-auto">
		<ul class="nav nav-tabs nav-justified ">
			<li class="nav-item"><a class="nav-link"
				href="<c:url value='/manager/showReports?cmd=article'/>"
				style="text-decoration: none; color: black;">文章</a></li>
			<li class="nav-item"><a class="nav-link"
				href="<c:url value='/manager/showReports?cmd=comment'/>"
		...
		<div class="container-fluid"
			...
			<c:forEach var="entry" items="${cmdName}">
				...
				<a
					href="<c:url value='/manager/showReportInfo?cmd=${cmd}&id=${cmdId}'/>"
