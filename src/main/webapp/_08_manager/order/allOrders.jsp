...
<body>
	<div class="w-75 my-5 mx-auto">
		<form action="<c:url value='/order/showOrders'/>">
		...
		<div class="container-fluid"
			...
			<c:forEach var="entry" items="${order_list}">
				<div class="row orderRow ${entry.status}">
					...
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">${entry.orderNo}</div>
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">
						<fmt:formatDate value="${entry.orderDate}" pattern="yyyy-MM-dd" />
					</div>
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">
						<a href=""><img
							src="${pageContext.request.contextPath}/image/_08_manager/more.png" style="width: 30px;" /></a>
					...
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">${entry.status}</div>
					<div class="col-1 text-center my-2"></div>
				</div>

				<div class="row orderItems" style="display: none;">
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2"></div>
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">商品名稱</div>
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">規格</div>
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">單價</div>
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">數量</div>
					<div
						class="col-2 text-center d-flex justify-content-center align-items-centertext-center my-2">總價</div>
