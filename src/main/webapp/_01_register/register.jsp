        ...
        <table>
          <tr>
            <td class="personalTitle">
              <font size="3" color="red">*</font> 帳號：&nbsp&nbsp
            </td>
            <td class="tdInput">
              <input
                id="userName"
          ...
          <tr>
            <td class="personalTitle">
              <font size="3" color="red">*</font> 密碼：&nbsp&nbsp
            </td>
            <td class="tdInput">
              <input
                id="password"
          ...
          <tr>
            <td class="personalTitle">
              <font size="3" color="red">*</font> 密碼確認：&nbsp&nbsp
            </td>
            <td class="tdInput">
              <input
                id="passwordCheck"
          ...
          <tr>
            <td class="personalTitle">
              <font size="3" color="red">*</font>性別：&nbsp&nbsp
            </td>
            <td class="tdInput">
              <input
                type="radio"
          ...
          <tr>
            <td class="personalTitle">
              <font size="3" color="red">*</font>生日：&nbsp&nbsp
            </td>
            <td class="tdInput">
              <input
                id="datepicker"
          ...
          <tr>
            <td class="personalTitle">
              <font size="3" color="red">*</font> E-mail：&nbsp&nbsp
            </td>
            <td class="tdInput">
              <input
                id="email"
          ...
          <tr>
            <td></td>
            <td class="errorText" id="emailText"></td>
          </tr>
          ...
          <tr>
            ...
            <td class="tdInput">
              ...
              <input name="address" value="" type="text" class="contentText" />
            </td>
          </tr>
          <tr>
            <td colspan="2">
